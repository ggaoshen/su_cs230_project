...
dense_model = [
    ...
    {"type":"Dense", "units":256*env.get_state().shape[1]},
    {"type":"Dense", "units":32}
]
conv_model = [
...
q_model = Q_Model("Dense", state_dim=env.get_state().shape, no_of_actions=env.no_of_actions, layers=gru_model, hyperparameters={"lr":0.0001})
agent = Agent(q_model, batch_size=8, discount_factor=0.995, epsilon=1)

no_of_episodes_train = 10
no_of_episodes_test = 10
